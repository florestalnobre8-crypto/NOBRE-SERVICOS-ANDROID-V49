...
async function refreshCloud(show=true){
  ...
  try{
    ...
    console.warn('Aplicação da sincronização V4.25:',e);
...
boot().catch(err=>{console.error('Falha na inicialização V4.25:',err);try{goScreen('home')}catch(_){};setTimeout(()=>{try{fastRefreshV45(false)}catch(_){}},1000)});
